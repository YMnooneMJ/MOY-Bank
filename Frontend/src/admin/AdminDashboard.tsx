...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const res = await axios.get("https://moy-bank.onrender.com/api/admin/stats");
        setStats(res.data);
      } catch (err) {
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className={cardClasses}>
          ...
          <div>
            <h2 className="text-xl font-semibold">₦{stats.totalVolume?.toLocaleString()}</h2>
        ...
        <div className={cardClasses}>
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Support Messages</p>
          </div>
        </div>
      </div>
    </div>
